            ...
            <div className="tab-content">
              ...
              <div className="tab-pane fade" id="step-02" role="tabpanel">
                <div className="row justify-content-between">
                  ...
                  <div className="col-lg-6">
                    <div className="feature-img">
                      <img src="./assets//assets/images/about/feature-2.png" alt />											
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="main-card team-card">
                    ...
                    <div className="team-content">
                      ...
                      <div className="user-social-links-group">
                        <a href="https://www.facebook.com/" className="user-social-link" target="_blank"><i className="fab fa-facebook-square" /></a>
                        <a href="https://www.instagram.com/accounts/login/" className="user-social-link" target="_blank"><i className="fab fa-instagram" /></a>
                        <a href="https://twitter.com/" className="user-social-link" target="_blank"><i className="fab fa-twitter" /></a>
                        <a href="https://www.linkedin.com/" className="user-social-link" target="_blank"><i className="fab fa-linkedin-in" /></a>
                      </div>
                    </div>
                  </div>
                </div>
