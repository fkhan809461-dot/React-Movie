...
<div>
  {/* Mirrored from www.gambolthemes.net/html-items/barren-html/disable-demo-link/create_venue_event.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 May 2025 16:41:47 GMT */}
  <meta charSet="utf-8" />
                ...
                <div className="step-content">
                          ...
                          <div className="row">
                            <div className="col-lg-12 col-md-12">
                              <div className="form-group border_bottom pb_30">
                                ...
                                <p className="mt-2 d-block fs-14 mb-3">See how your name appears on the event page and a list of all places where your event name will be used. <a href="#" className="a-link">Learn more</a></p>
                                <input className="form-control h_50" type="text" placeholder="Enter event name here" defaultValue />
                              </div>
                              <div className="form-group border_bottom pt_30 pb_30">
                                ...
                                <p className="mt-2 d-block fs-14 mb-3">Choosing relevant categories helps to improve the discoverability of your event. <a href="#" className="a-link">Learn more</a></p>
                                {/* <select className="selectpicker" multiple data-selected-text-format="count > 4" data-size={5} title="Select category" data-live-search="true">
                              ...
                              <div className="form-group border_bottom pt_30 pb_30">
                                ...
                                <div className="row g-2">
                                  <div className="col-md-6">
                                    ...
                                    <div className="loc-group position-relative">
                                      <input className="form-control h_50 datepicker-here" data-language="en" type="text" placeholder="MM/DD/YYYY" defaultValue />
                                      <span className="absolute-icon"><i className="fa-solid fa-calendar-days" /></span>
                                    </div>
                                  </div>
                                  <div className="col-md-6">																		
                                    <div className="row g-2">
                              ...
                              <div className="form-group pt_30 pb_30">
                                ...
                                <p className="mt-2 fs-14 d-block mb-3 pe_right">Upload colorful and vibrant images as the banner for your event! See how beautiful images help your event details page. <a href="#" className="a-link">Learn more</a></p>
                                    ...
                                    <div className="row g-4">
                                      ...
                                      <div className="col-md-6">
                                        <div className="form-group mt-1">
                                          ...
                                          <input className="form-control h_50" type="text" placeholder defaultValue="Victoria" />																								
                                        </div>
                                      </div>
                                      <div className="col-lg-6 col-md-12">
                                        <div className="form-group mt-1">
                                          <label className="form-label">City/Suburb*</label>
                                          <input className="form-control h_50" type="text" placeholder defaultValue="Melbourne" />																								
                                        </div>
                                      </div>
                                      <div className="col-lg-6 col-md-12">
                                        <div className="form-group mt-1">
                                          <label className="form-label">Zip/Post Code*</label>
                                          <input className="form-control h_50" type="text" placeholder defaultValue={3000} />																								
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                  ...
                  <div className="step-tab-panel step-tab-gallery" id="tab_step2">
                    <div className="tab-from-content">
                      <div className="main-card">
                        <div className="bp-title">
                          <h4><i className="fa-solid fa-ticket step_icon me-3" />Tickets</h4>
                        </div>
                          ...
                          <div className="p-4 form-group border_bottom pb_30">
                            <div className>
                              ...
                              <div className="d-flex align-items-center justify-content-between pt-4 pb-3 full-width">
                                <h3 className="fs-18 mb-0">Tickets (<span className="venue-event-ticket-counter">3</span>)</h3>
                                <div className="dropdown dropdown-default dropdown-normal btn-ticket-type-top">
                                  <button className="dropdown-toggle main-btn btn-hover h_40 pe-4 ps-4" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span>Add Tickets</span>
                                  </button>
                                  <div className="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton" style={{}}>
                                    <a className="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#singleTicketModal">
                                      <i className="fa-solid fa-ticket me-2" />
                                      Single Ticket
                                    </a>
                                    <a className="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#groupTicketModal">
                                      <i className="fa-solid fa-ticket me-2" />
                                      Group Ticket
                                    </a>
                                  </div>
                              ...
                              <div className="ticket-type-item-empty d-none text-center p_30">
                              ...
                              <div className="ticket-type-item-list mt-4">
                                  ...
                                  <div className="price-ticket-card-head d-md-flex flex-wrap align-items-start justify-content-between position-relative p-4">
                                    <div className="d-flex align-items-center top-name">
                                      <div className="icon-box">
                                        ...
                                        <h5 className="fs-16 mb-1 mt-1">New Small - $10.00</h5>
                                        <p className="text-gray-50 m-0"><span className="visitor-date-time">May 3, 2022</span></p>
                                      </div>
                                    </div>
                                  ...
                                  <div className="price-ticket-card-body border_top p-4">
                                    <div className="full-width d-flex flex-wrap justify-content-between align-items-center">
                                      ...
                                      <div className="icon-box">
                                        ...
                                        <h6 className="coupon-status">2</h6>
                                      </div>
                                      <div className="icon-box">
                                        <div className="icon me-3">
                                        ...
                                        <h6 className="coupon-status">5%</h6>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div className="price-ticket-card mt-4">
                                  <div className="price-ticket-card-head d-md-flex flex-wrap align-items-start justify-content-between position-relative p-4">
                                    <div className="d-flex align-items-center top-name">
                                      <div className="icon-box">
                                        <span className="icon-big rotate-icon icon icon-yellow">
                                          <i className="fa-solid fa-ticket" />
                                        </span>
                                        <h5 className="fs-16 mb-1 mt-1">Group - $10.00</h5>
                                        <p className="text-gray-50 m-0"><span className="visitor-date-time">May 3, 2022</span></p>
                                      </div>
                                    </div>
                                    <div className="d-flex align-items-center">
                                  ...
                                  <div className="price-ticket-card-body border_top p-4">
                                    <div className="full-width d-flex flex-wrap justify-content-between align-items-center">
                                      <div className="icon-box">
                                        ...
                                        <span className="text-145">Total tickets</span>
                                        <h6 className="coupon-status">Unlimited</h6>
                                      </div>
                                      <div className="icon-box">
                                        <div className="icon me-3">
                                          <i className="fa-solid fa-users" />
                  ...
                  <div className="step-tab-panel step-tab-location" id="tab_step3">
                    <div className="tab-from-content">											
                      <div className="main-card">
                        <div className="bp-title">
                          <h4><i className="fa-solid fa-gear step_icon me-3" />Setting</h4>
                        </div>
                            ...
                            <div className="ticket-section">
                              ...
                              <div className="content-holder">
                                <div className="setting-item border_bottom pb_30 pt-4">
                                  <div className="d-flex align-items-start">
                                    <label className="btn-switch m-0 me-3">
                                      <input type="checkbox" className id="booking-start-time-btn" defaultValue defaultChecked />
                                      <span className="checkbox-slider" />
                                    </label>
                                    <div className="d-flex flex-column">
                                ...
                                <div className="setting-item border_bottom pb_30 pt_30">
                                  <div className="d-flex align-items-start">
                                    <label className="btn-switch m-0 me-3">
                                      <input type="checkbox" className id="booking-end-time-btn" defaultValue defaultChecked />
                                      <span className="checkbox-slider" />
                                    </label>
                                    <div className="d-flex flex-column">
                                ...
                                <div className="setting-item border_bottom pb_30 pt_30">
                                  <div className="d-flex align-items-start">
                                    <label className="btn-switch m-0 me-3">
                                      <input type="checkbox" className id="passing-service-charge-btn" defaultValue defaultChecked />
                                      <span className="checkbox-slider" />
                                    </label>
                                    <div className="d-flex flex-column">
                                      ...
                                      <p className="mt-2 fs-14 d-block mb-0 pe_right">Passing your service charge means your attendees will pay your service charge in addition to the ticket price. <a href="#" className="a-link">Learn more</a></p>
                                    </div>
                                  </div>
                                </div>
                                <div className="setting-item border_bottom pb_30 pt_30">
                                  <div className="d-flex align-items-start">
                                    <label className="btn-switch m-0 me-3">
                                      <input type="checkbox" className id="refund-policies-btn" defaultValue defaultChecked />
                                      <span className="checkbox-slider" />
                                    </label>
                                    <div className="d-flex flex-column">
                                    ...
                                    <div className="refund-policies-content border_top mt-4">
                                      <div className="row grid-padding-8">
                                        <div className="col-md-12 mb-6">
                                          <div className="refund-method">
                                            <div className="form-group mb-0">
                                              <label className="brn-checkbox-radio mb-0 mt-4">
                                                <input type="radio" required name="refund_policy_id" defaultValue="refund-id-1" className="form-check-input br-checkbox refund-policy1" />
                                          ...
                                          <div className="refund-method">
                                            <label className="brn-checkbox-radio mb-0 mt-4">
                                              <input type="radio" name="refund_policy_id" defaultValue="refund-id-2" className="form-check-input br-checkbox refund-polic-2" />
                                                ...
                                                <div className="d-block d-md-flex align-items-center flex-wrap flex-lg-wrap-reverse">
                                                  <div className="col-md-4">
                                                    <div className="input-group loc-group position-relative">
                                                      <input type="text" defaultValue className="form-control" placeholder />
                                                      <span className="percentage-icon"><i className="fa-solid fa-percent" /></span>
                                                    </div>
                                                  </div>
                                                  <div className="input-sign ms-md-3 mt-3 mb-3">days before the event</div>
                                                </div>
                                ...
                                <div className="setting-item border_bottom pb_30 pt_30">
                                  <div className="d-flex align-items-start">
                                    <label className="btn-switch m-0 me-3">
                                      <input type="checkbox" className id="ticket-instructions-btn" defaultValue defaultChecked />
                                      <span className="checkbox-slider" />
                                    </label>
                                    <div className="d-flex flex-column">
                                ...
                                <div className="setting-item pb-0 pt_30">
                                  <div className="d-flex align-items-start">
                                    <label className="btn-switch m-0 me-3">
                                      <input type="checkbox" className id="tags-btn" defaultValue defaultChecked />
                                      <span className="checkbox-slider" />
                                    </label>
                                    <div className="d-flex flex-column">
                                      <label className="color-black fw-bold mb-1">I do not want to add tags in my event</label>
                                      <p className="mt-2 fs-14 d-block mb-0">Use relevant words as your tags to improve the discoverability of your event. <a href="#" className="a-link">Learn more</a></p>
                                    </div>
                                  </div>
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <div className="footer-content">
              ...
              <div className="download-app-link">
                <a href="#" className="download-btn"><img src="images/app-store.png" alt /></a>
                <a href="#" className="download-btn"><img src="images/google-play.png" alt /></a>
              </div>
            </div>
          </div>
        </div>
